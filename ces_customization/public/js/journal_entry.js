...
frappe.ui.form.on("Journal Entry", {
    ...
    update_ces_fields(frm) {
        //Populate CES field
        const month_l = new Array('x', 'มกราคม', 'กุมภาพันธ์', 'มีนาคม', 'เมษายน', 'พฤษภาคม', 'มิถุนายน', 'กรกฎาคม', 'กันยายน', 'ตุลาคม', 'พฤศจิกายน', 'ธันวาคม');
        const month_s = new Array('x', 'ม.ค.', 'ก.พ.', 'มี.ค.', 'เม.ย.', 'พ.ค.', 'มิ.ย.', 'ก.ค.', 'ก.ย.', 'ต.ค.', 'พ.ย.', 'ธ.ค.')
        ...
        frm.set_value('ces_th_mm', month_s[pd_month]);
        frm.set_value('ces_th_mmmm', month_l[pd_month]);
        frm.set_value('ces_be_yy', pd_year_be % 100);
        frm.set_value('ces_be_yyyy', pd_year_be);
        frm.set_value('ces_be_date', be_date);
